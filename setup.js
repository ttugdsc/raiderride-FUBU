        ...
        task: function (ctx, task) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, (0, execa_1["default"])('yarn --version', {
            ...
            return task.newListr([
                {
                    ...
                    task: function (ctx, sub) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(process.env.MODE !== undefined)) return [3 /*break*/, 1];
                                    sub.output = "MODE is set as: ".concat(chalk.blueBright(process.env.MODE));
                                    sub.title = 'Found Application Mode';
                                    return [3 /*break*/, 4];
                                case 1:
                                    sub.title = 'MODE not found, adding...';
                                    return [4 /*yield*/, fs.promises.appendFile('.env', '\nMODE=DEV')];
                                case 2:
                                    _a.sent();
                ...
                },
                {
                    ...
                    task: function (ctx, sub) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(process.env.RADAR_API_KEY !== undefined)) return [3 /*break*/, 1];
                                    sub.output = "RADAR_API_KEY is set as: ".concat(chalk.blueBright(process.env.RADAR_API_KEY));
                ...
                },
                {
                    ...
                    task: function (ctx, sub) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(process.env.TENANT !== undefined)) return [3 /*break*/, 1];
                                    sub.title = 'Found OAuth Tenant Value';
                                    sub.output = "TENANT is set as: ".concat(chalk.blueBright(process.env.TENANT));
